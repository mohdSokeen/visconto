    ...
    <section id="services" className="py-0 px-6 md:px-20">
      {/* <div className="max-w-7xl mx-auto px-6 lg:px-10"> */}
        ...
        <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
          ...
          <p className="mt-3 text-slate-600 dark:text-slate-300 max-w-2xl mx-auto text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            {
              icon: faUsers,
              title: "Contract Staffing / Team Augmentation",
              desc: "Scale instantly with vetted professionals who integrate into your workflow.",
            },
            {
              icon: faBriefcase,
              title: "Direct Hire & Executive Search",
              desc: "We find culture-fit leaders and high-impact full-time talent.",
            },
            {
              icon: faUserCheck,
              title: "Contract-to-Hire",
              desc: "Evaluate talent performance before committing to a long-term hire.",
            },
            {
              icon: faLayerGroup,
              title: "Project-Based Delivery",
              desc: "Full project teams managed and delivered to meet tight deadlines.",
            },
            {
              icon: faCogs,
              title: "Workforce Strategy Consulting",
              desc: "Proactive guidance on hiring, retention, compensation, and planning.",
            },
            {
              icon: faRocket,
              title: "Recruitment Process Outsourcing (RPO)",
              desc: "We manage your full hiring pipeline — ideal for high-volume recruiting.",
            },
          ].map((item, index) => (
            <motion.div
              key={index}
              ...
              whileInView="visible"
              variants={fadeUp}
              className="p-6 rounded-2xl bg-white/70 dark:bg-black/40 backdrop-blur border shadow hover:shadow-xl transition-shadow cursor-pointer"
            >
              ...
              <p className="text-sm opacity-80 mt-3 leading-relaxed">{item.desc}</p>
            </motion.div>
          ))}
        </div>
        ...
        <motion.div
          ...
          whileInView="visible"
          variants={fadeUp}
          className="mt-14 overflow-hidden rounded-xl border backdrop-blur bg-white/60 dark:bg-black/40 shadow"
        >
        ...
        >
          ...
          <button className="mt-10 px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-rose-500 text-white font-semibold shadow hover:scale-105 transition-transform">
